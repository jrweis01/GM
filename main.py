...
@click.command()
@click.option('--mode', '-m', default='test', help='test mode will execute tests and comparisons, '
                                                   'data mode will run the analysis and provide the user with details'
                                                   'without comparing the results to a baseline')
...
def main(mode, checkpoint, save, images):
    """This module requires at least one image (-i) in the command line.
